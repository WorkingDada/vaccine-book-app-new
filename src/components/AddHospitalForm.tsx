        ...
        <>
            {
                ...
                <form action={addHospital}>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type="text" required id="district" name="district" placeholder="Address District"
                        className="bg-white border-2 border-gray-200 rounded w-full p-2 text-gray-700 
                        focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type="text" required id="province" name="province" placeholder="Address Province"
                        className="bg-white border-2 border-gray-200 rounded w-full p-2 text-gray-700 
                        focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type="text" required id="postalcode" name="postalcode" placeholder="Address Postalcode"
                        className="bg-white border-2 border-gray-200 rounded w-full p-2 text-gray-700 
                        focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div className="flex items-center w-1/2 my-2">
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block text-gray-700 pr-4" htmlFor="pic">
                            Picture
                        </label>
                        <input type="text" required id="pic" name="pic" placeholder="URL"
                        className="bg-white border-2 border-gray-200 rounded w-full p-2 text-gray-700 
                        focus:outline-none focus:border-blue-400"/>
                    </div>
                    <button type="submit" className="bg-blue-500 hover:bg-blue-700
                    text-white p-2 rounded">Create New Hospital</button>
                </form>
                :
                null
            }
